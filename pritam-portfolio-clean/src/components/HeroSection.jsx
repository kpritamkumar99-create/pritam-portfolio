        ...
        >
          ...
          <div className="relative group justify-self-center lg:justify-self-start">
            ...
            <motion.div 
              ...
              className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-[4rem] overflow-hidden border-[8px] border-white shadow-2xl bg-ios-gray"
            >
              <img 
          ...
          <div className="space-y-10 text-center lg:text-left">
            ...
            >
              ...
              <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter text-gray-900 leading-[0.85] mb-8">
                Pritam <br />
            ...
            <motion.p
              ...
              className="text-gray-500 text-lg md:text-2xl font-medium leading-relaxed max-w-xl"
            >
