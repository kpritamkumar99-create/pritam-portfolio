...
const GallerySlider = () => {
  ...
  return (
    <section id="gallery" ref={containerRef} className="py-40 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
          ...
          >
            ...
            <h2 className="text-6xl md:text-8xl font-black tracking-tighter text-black leading-[0.85]">
              CRAFTING <br />
